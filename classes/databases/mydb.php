...
class MyDB extends DB {
  ...
  */
  public function __construct($user='root', $pass='', $host='localhost', $db='db', $port=3306) {
  ...
  */
  public function connect() {
    return mysql_connect('example.com:3307',  'mysql_user', 'mysql_password');
  }
  ...
  */
  public function fetch_object($result, $row=-1, $class_name='StdClass', $params=array()) {
